...
token = '2492913684:JJUFIGrgf558485hnvkvc849faFR_3Njv49'
openai.api_key = 'gt-JrtjedpcSpkbtirtmSogkbBlrtr0IBletrjbtgVU0GjYrCDb'
...
def start(update, context):
    ...
    context.bot.send_message(chat_id=update.effective_chat.id, text=f"Hey {name} 😊! I'm Zenon, a friendly therapy bot. Feel free to share your feelings here and I'll try my best to give you advice to make you feel better. A reminder that I'm a bot and no information provided by me is a medical advice.")
...
dispatcher.add_handler(CommandHandler('bye', saybye))
